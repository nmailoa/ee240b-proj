...
Finally, to determine that the noise spec was met, we ran noise sims over XXX1600XXX sidebands and XXX400XXX harmonics. We used ideal switches instead of transistors, but used series resistors to simulate noise from switch resistance. We input referred the noise to obtain the values seen in the results.\\
